...
function submitData() {
  ...
  if (skillprogramming) {
    skillprogramming = document.getElementById("input-programming").value;
  } else {
    skillprogramming = "";
  }
  if (skillfootball) {
    skillfootball = document.getElementById("input-football").value;
  } else {
    skillfootball = "";
  }
  if (skillsleep) {
    skillsleep = document.getElementById("input-sleep").value;
  } else {
    skillsleep = "";
  }
